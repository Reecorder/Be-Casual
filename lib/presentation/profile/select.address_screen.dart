...
// current loaction field
          ...
          child: InkWell(
              ...
              child: Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(5),
                    border: Border.all(
                        color: controller.selctedAddress.value == index
                            ? AppColors.black.withOpacity(0.9)
                            : Colors.black12,
                        width:
                            controller.selctedAddress.value == index ? 1.5 : 1),
                  ),
                  child: Padding(
  ...
  Widget addressTile(
          {required int index, required Map<String, String> address}) =>
      Obx(() => Padding(
            padding: const EdgeInsets.only(top: 10),
            child: InkWell(
              onTap: () {
