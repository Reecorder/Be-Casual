...
class _OrderScreenState extends State<OrderScreen> {
  ...
  void initState() {
    ...
    // If caller passes skipFetch=true we avoid remote fetch to preserve local orders
    if (args['skipFetch'] != true) {
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  /* order status */
                                  Text(
                                    ordercontroller.ordermodel[index].status
                                        .toString(),
                                    style: TextStyle(
